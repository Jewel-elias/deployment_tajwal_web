      ...
      <div className='shkoaCont' id='shkoaCont'>
        ...
        <div className='forStor'>
          ...
          <div className='storeSendhkoa'>
            {/* <div>{idS.current}</div> */}
            <img src={state.stores.features[idS.current].properties.photo} className='imgLog' />
            <span className='titleShkoa'>{state.stores.features[idS.current].properties.name}</span>
          </div>
        </div>
